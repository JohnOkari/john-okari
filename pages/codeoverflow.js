    ...
    <div className="w-ful bg-[#181822] h-[100vh] text-white">
      ...
      <div className="max-w-[1240px] mx-auto p-12 grid md:grid-cols-5  gap-8 pt-5">
        <div className="col-span-4">
          ...
          >
            codeOverflow is a Stack Overflow inspired full-stack application. Users can post questions and answers related to programming.
            It serves as a forum for developers to share their expertise and aid those who are having coding issues.
            In addition to posting, users can also cast votes for the top answers, search questions, and even add tags to describe the topic of their question.
            
          </p>
          <Link href="https://github.com/JohnOkari/codeoverflow">
