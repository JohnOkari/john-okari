    ...
    <div className="w-ful bg-[#181822] h-[100vh] text-white">
      ...
      <div className="max-w-[1240px] mx-auto p-12 grid md:grid-cols-5  gap-8 pt-5">
        <div className="col-span-4">
          ...
          >
            This is a blogging website that enables content creators, particularly those with an interest in technical writing,
             to publish, oversee, and share their blog posts. .
          </p>
          <Link href="https://github.com/JohnOkari/inscribe-blog-app">
